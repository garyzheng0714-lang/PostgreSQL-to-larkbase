...
_PRIMARY_CAPABLE = {
    FIELD_TEXT, FIELD_NUMBER, FIELD_DATE, FIELD_HYPERLINK,
    FIELD_PHONE, FIELD_BARCODE, FIELD_CURRENCY,
}
...
def can_be_primary(field_type: int) -> bool:
    """Check if a Bitable field type can be used as the primary column."""
    return field_type in _PRIMARY_CAPABLE
